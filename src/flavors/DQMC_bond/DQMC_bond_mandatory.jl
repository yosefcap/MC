...
"""
Base.rand(::Type{DQMC_bond}, m::Model, nslices::Int) = error("Model $(typeof(m)) doesn't implement `rand(::Type{DQMC_bond}, m::Model, nslices::Int)`!")


"""
	hopping_matrix(mc::DQMC_bond, m::Model)
...
"""
hopping_matrix(mc::DQMC_bond, m::Model) = error("Model has no implementation of `hopping_matrix(mc::DQMC_bond, m::Model)`.")


"""
    interaction_matrix_exp!(mc::DQMC_bond, m::Model, result::Matrix, conf, slice::Int, power::Float64=1.) -> nothing
...
"""
interaction_matrix_exp!(mc::DQMC_bond, m::Model, result::Matrix, conf, slice::Int, power::Float64=1.) = error("Model has no implementation of `interaction_matrix_exp!(mc::DQMC_bond, m::Model, result::Matrix, conf, slice::Int, power::Float64=1.)`.")


"""
    propose_local(mc::DQMC_bond, m::Model, i::Int, conf) -> detratio, ΔE_boson, Δ
...
"""
propose_local(mc::DQMC_bond, m::Model, i::Int, conf) =
    error("Model has no implementation of `propose_local(mc::DQMC_bond, m::Model, i::Int, conf)`!")

"""
    accept_local(mc::DQMC_bond, m::Model, i::Int, slice::Int, conf, Δ, detratio, ΔE_boson)
...
"""
accept_local(mc::DQMC_bond, m::Model, i::Int, slice::Int, conf, Δ, detratio, ΔE_boson) =
    error("Model has no implementation of `accept_local(mc::DQMC_bond, m::Model, i::Int, slice::Int, conf, Δ, detratio, ΔE_boson)`!")
